...
<body>
	<nav class="navbar navbar-expand-md bg-white navbar-light fixed-top pb-0">
		<div class="container">
	  		<a class="navbar-brand" href="<?php echo $this->config->item('my_base_url')?>index-2"><img src="<?php echo base_url()?>assets/dist/img/logo/logo.png"></a>
	  		...
	  		<div class="collapse navbar-collapse" id="collapsibleNavbar">
	    		<ul class="navbar-nav ml-auto mr-auto d-xl-flex">
	      			...
	      			<li class="nav-item for-mobile">
	  					<a href="<?php echo $this->config->item('my_base_url')?>index-2#plans-div" class="hdr-view-data-plans">View Data Plans</a>
                    </li>
