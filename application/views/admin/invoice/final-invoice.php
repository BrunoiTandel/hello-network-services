...
$product = json_decode($invoice['package_details'],true);
$test_ntw = $ntw->numToWord(2250);
$date = new DateTime($invoice['purchased_date']); // Y-m-d
$date->add(new DateInterval('P30D'));
$next_due_date =  $date->format('Y-m-d') . "\n";
// $next_due_date = date($invoice['purchased_date'], strtotime("+30 days"));
            ...
            <table class="table">
                <tr>
                    ...
                    <td class="hdr-tax-invoice-main-td">
                        <div class="hdr-invoice-date-div">Date: '.$invoice['purchased_date'].'</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="container-fluid">
            <table class="table no-spacing invoice-details" cellspacing="0">
                <tr>
                    ...
                    <td>
                        To,<br>
                        <span class="text-bold">'.$invoice['username'].',</span><br>
                        '.$invoice['address'].'<br>
                        <span class="text-bold">Phone:</span> '.$invoice['phone'].'<br>
                        <span class="text-bold">Email:</span> '.$invoice['email'].'
                    </td>
                    <td>
                        <span class="text-bold">User ID:</span> #'.$invoice['user_id'].'<br>
                        <span class="text-bold">Due Date:</span> '.$next_due_date.'<br>
            ...
            <table class="purchased-package-components-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>'.$product['product_data_speed'].'</td>
            ...
            <div class="w-50">
                <table class="show-total-sub-total-and-grand-total-table w-100">
                    ...
                    <tr>
                        ...
                        <td class="text-right"><span class="text-bold">₹</span>'.$invoice['amount_paid'].'</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="border-top"></div>
