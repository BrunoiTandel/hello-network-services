<?php
    ...
    } else if (strtolower(uri_string()) == 'factsuite-admin/client-logo') {
      $client_logo_active = 'active';
    } else if (strtolower(uri_string()) == 'factsuite-admin/add-testimonials') {
      $add_testimonials_active = 'active';
    } else if (strtolower(uri_string()) == 'factsuite-admin/all-testimonials') {
...
?>
      ...
      <span class="edit-pages-txt">Home Page Content</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="content-nav-tabs-container">
          <ul class="nav nav-tabs main-nav-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-product-tab <?php echo $add_testimonials_active;?>" href="<?php echo $this->config->item('my_base_url')?>factsuite-admin/add-testimonials">Add Testimonials</a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-link-product-tab <?php echo $all_testimonials_active;?>" href="<?php echo $this->config->item('my_base_url')?>factsuite-admin/all-testimonials">All Testimonials</a>
            </li>
          </ul>