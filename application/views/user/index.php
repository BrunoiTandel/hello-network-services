...
<div class="container-fluid custom-container-fluid-2 d-none">
   ...
   <div class="container">
      ...
      <div class="news-list-div">
      	...
      	foreach ($news as $key => $value){ ?>
	         <div class="news-item">
	         	<a href="#">
		         	<img class="news-img" src="<?php echo base_url()?>assets/user/images/<?php echo $value['blog_thumbnail_image']; ?>">
